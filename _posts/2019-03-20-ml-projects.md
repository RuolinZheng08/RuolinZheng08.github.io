...
#### [View My Project Write-Up](https://github.com/RuolinZheng08/cmsc25400-machine-learning/blob/master/project2/CMSC_25400_HW2.pdf)  
<span>
...
#### [View My Project Write-Up](https://github.com/RuolinZheng08/cmsc25400-machine-learning/blob/master/project3/CMSC_25400_HW3.pdf)  
<img src="{{ site.baseurl }}/images/ml-p3-result.png" style="width: 350px;"/>
...
#### [View My Project Write-Up](https://github.com/RuolinZheng08/cmsc25400-machine-learning/blob/master/project4/CMSC_25400_HW4.pdf)
<span>
...
**Description:** Implement a **Neural Net (Forward Pass + Back Propagation)** to classify digits from the MNIST dataset.
#### [View My Project Write-Up](https://github.com/RuolinZheng08/cmsc25400-machine-learning/blob/master/project5/CMSC_25400_HW5.pdf)  
<img src="{{ site.baseurl }}/images/ml-p5-result.png" style="width: 350px;"/>
...
As the training result turns out, the fact that LSTM picks up the pronouns quite fast speaks to its strength in remembering longer-term context (i.e., first word of the first sentence.)
#### [View My Project Write-Up](https://github.com/RuolinZheng08/cmsc25400-machine-learning/blob/master/project6/CMSC_25400_HW6.pdf)  
<img src="{{ site.baseurl }}/images/ml-p6-result.png" style="width: 350px;"/>